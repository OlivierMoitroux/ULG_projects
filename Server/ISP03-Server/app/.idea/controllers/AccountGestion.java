...
public class AccountGestion extends Controller {
    ...
    public Result getUserData(){
        ...
        List<Habit> e = db.selectHabits(client.id);
        ArrayNode array = mapper.valueToTree(e);
        JsonNode son2 = mapper.createObjectNode();
        ((ObjectNode) son2).putArray("Habits").addAll(array);
        ((ObjectNode) rootNode).set("Habits", son2);
